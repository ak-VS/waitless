      ...
      <div style={s.body}>
        ...
        {(table_label && !is_any) && (
          <div style={s.tableCard}>
            ...
            <button style={s.tcChange} onClick={() => router.back()}>Change</button>
          </div>
        )}
...
const s: any = {
  page:{background:'var(--bg)',minHeight:'100vh',display:'flex',flexDirection:'column',maxWidth:480,margin:'0 auto'},
  ...
  paxBtn:{flex:1,minWidth:44,background:'var(--bg3)',border:'1px solid var(--border2)',color:'var(--text2)',fontFamily:"'Jost',sans-serif",fontSize:13,padding:'10px 4px',borderRadius:2,cursor:'pointer',textAlign:'center'},
  paxOn:{background:'rgba(201,168,76,.1)',borderColor:'var(--gold)',color:'var(--gold)'},
